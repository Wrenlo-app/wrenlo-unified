  ...
  return (
    <TradePage
      ...
      faqs={[
        ...
        { q: "What happens if a call is a real emergency?", a: "Wrenlo never troubleshoots. Security concerns and stuck doors escalate immediately to the owner, with basic safety guidance to the caller." },
