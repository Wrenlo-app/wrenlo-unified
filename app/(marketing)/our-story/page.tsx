...
const TIMELINE = [
  ...
  },
  {
    icon: "🚀",
    year: "Today",
    title: "In pilot with contractors across HVAC, plumbing, electrical, and more",
    body: "Wrenlo is live in pilot with contractors across multiple trades and markets. Every pilot account gets a trade-specific playbook, owner-defined booking rules, and a revenue dashboard that shows exactly how many calls were recovered and what they were worth. We are building this product in close partnership with the contractors who need it most.",
    active: true,
  },
];
