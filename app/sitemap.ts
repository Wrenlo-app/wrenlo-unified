...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/plumbing`, lastModified: new Date(), priority: 0.8 },
    { url: `${baseUrl}/electrical`, lastModified: new Date(), priority: 0.8 },
    { url: `${baseUrl}/roofing`, lastModified: new Date(), priority: 0.8 },
    { url: `${baseUrl}/garage-door`, lastModified: new Date(), priority: 0.8 },
    { url: `${baseUrl}/pest-control`, lastModified: new Date(), priority: 0.8 },
